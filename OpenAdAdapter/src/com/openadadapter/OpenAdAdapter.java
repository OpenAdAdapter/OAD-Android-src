...
public class OpenAdAdapter {
	...
	/**
	 * Verifies if application setup properly to work with ad networks. 
	 * It checks AndroidManifest.xml activities, permissions, meta tag
	 * @param activity - main activity
	 * @param networks - array of ad network names
	 */
	...
	/** 
	 * Verifies if application setup to work with ad network
	 * @param name - ad network name
	 */
	...
	/**
	 * Initialize OpenAdAdapter with URL pointing to JSON file in Internet
	 * e.g. https://raw.githubusercontent.com/sample-data/oad1/master/data1.json
	 * You must use your own JSON file with your ad network IDs
	 * 
	 * @param activity
	 * @param url
	 */
	...
	/**
	 * Some ad networks track activity life-circle. 
	 * OpenAdAdapter.onStart(this); 
	 * must be placed in activities onStart method to support such networks
	 * @param activity
	 */
	 ...
	 * must be placed in activities onCreate method to support such networks
	 * @param activity
	 */
	 ...
	 * must be placed in activities onResume method to support such networks
	 * @param activity
	 */
	 ...
	 * must be placed in activities onPause method to support such networks
	 * @param activity
	 */
	 ...
	 * must be placed in activities onStop method to support such networks
	 * @param activity
	 */
	 ...
	 * must be placed in activities onDestroy method to support such networks
	 * @param activity
	 */
	...
	/**
	 * To track back button when fullscreen, video and rewarded videos are shown add
	 * OpenAdAdapter.onBackPressed(this); 
	 * in activities onBackPressed method
	 * @param activity
	 * @return
	 */
	...
	/**
	 * Shows banner in the top. Tag parameter is not used.
	 * @param tag - not used right now
	 */
	...
	/**
	 * Shows banner in the bottom. Tag parameter is not used.
	 * @param tag - not used right now
	 */
	...
	/**
	 * Returns Reward object (amount, network, currency)
	 * @return - reward
	 */
	...
	/**
	 * Banner height in pixels. Positive value if banner is shown in the top and negative value if banner is shown in the bottom 
	...
	/**
	 * Banner height in points/dp. Positive value if banner is shown in the top and negative value if banner is shown in the bottom 
	 * @return banner height
	 */
